...
function obtenerDatos() {
    ...
    const Nasa_API = 'OKiEvjyd0SI23LfcEA6aTzpGbFStEVyKWoDT2hEa';
    const ruta = `https://api.nasa.gov/planetary/apod?api_key=${Nasa_API}`; //implemento key y direccion de la api
